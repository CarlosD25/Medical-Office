...
class ConsultRoomRepositoryTest {
    ...
    void setUp() {
        ...
        appointment.setStartTime(LocalDateTime.of(2025, 4, 24, 10, 0));
        appointment.setEndTime(LocalDateTime.of(2025, 4, 24, 11, 0));
    ...
    void whenAppointmentOverlaps_thenReturnTrue() {
        boolean result = consultRoomRepository.consultRoomHasAppointment(
                consultRoom.getId(),
                LocalDateTime.of(2025, 4, 24, 10, 30),
    ...
    void whenNoAppointmentOverlap_thenReturnFalse() {
        boolean result = consultRoomRepository.consultRoomHasAppointment(
                consultRoom.getId(),
                LocalDateTime.of(2025, 4, 24, 11, 0),
                LocalDateTime.of(2025, 4, 24, 12, 0)
        );
        assertFalse(result);
    }
}